...
function canAccessFeature($userRole, $feature) {
    $featureAccess = [
        'tambah_barang' => ['admin', 'karyawan_barang_keluar'],
        'action' => ['admin', 'karyawan_barang_keluar'],
        'edit' => ['admin', 'karyawan_barang_keluar'],
    ];
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-100">Barang Keluar</h1>
                    ...
                    <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <form action="./function/export_barangkeluar.php">
                    ...
                    <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <tbody>
                                    <?php
                                    $ambilsemuadatamasuk = mysqli_query($conn, "SELECT * FROM keluar, stock where stock.idbarang = keluar.idbarang and keluar.notification = 0");
            ...
            <div class="modal-body">
                ...
                <div id="errorMessageContainer">
                    ...
                    if (isset($_SESSION['error_message'])) {
                        echo "<div class='alert alert-danger' id='errorMessage'>{$_SESSION['error_message']}</div>";
                        unset($_SESSION['error_message']); // Menghapus pesan error dari sesi setelah ditampilkan
                    }
                    ?>
                </div>
                <button type="submit" id='submitButton' class="btn btn-primary" name="barangmetu">Submit</button>
            </div>
        </form>
...
<script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(event) {
                ...
                if (errorMessage) {
                    event.preventDefault(); // Mencegah pengiriman form jika ada pesan error
